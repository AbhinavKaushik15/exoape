      ...
      <div className="right relative h-[91vh] w-full sm:w-[37.7vw]">
        <div className="close flex sm:absolute sm:top-0 sm:right-0 text-white items-center justify-between">
          ...
          <button onClick={()=>setisOpen(!isOpen)} className="text-xs flex items-center">
            ...
            <IoCloseOutline className={`text-2xl text-[#dadada] font-[100] ${isOpen && 'hover:rotate-90'} transition-all`} />
          </button>
        ...
        <div className="absolute w-full ml-6 sm:ml-0 sm:w-[21.3vw] h-[30.2vw] top-1/2 -translate-y-1/2 left-0 font-[Lausanne_300] leading-[1.3]">
          <div className="texts absolute w-full h-fit top-1/2 -translate-y-1/2">
            <div className="headings text-white -mt-10 sm:mt-0">
              {["Work", "Studio", "News", "Contact"].map((items, index) => {
                return (
                  <h1 key={index} className="text-[9vh] sm:text-[3.5vw] leading-[1.1] font-[400] overflow-hidden">
                    <motion.span
        ...
        <h1 className="flex sm:hidden underline text-[3.5vw] text-white mt-[63vh] ml-6">
          Now Hiring!
        </h1>
